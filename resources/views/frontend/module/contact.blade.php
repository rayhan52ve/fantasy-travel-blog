            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="blog_text_slider">
                        <div class="blog_text">
                            <img class="img-fluid" src="{{asset('assets/frontend/img/banner/contact-img.png')}}" alt="">
    ...
    <section class="contact_area section-gap">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <form class="row contact_form" action="{{route('contact.store')}}" method="HEAD" id="contactForm"
